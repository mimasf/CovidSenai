...
import MaView, { Marker, Callout } from "react-native-maps";
import {
...
import coords from "../../database/statess";
...
function Home() {
  ...
  return (
    <Container>
      ...
      <MapView
        onRegionChangeCompleto={handleRegionChanged}
        style={{ flex: 1 }}
